...
def update_bgp_table(tableName, vpnId, cgwId, instanceId, ipSegment):
    table = dynamodb.Table(tableName)
    """Updates the BGP table with vpnId and cgwId
    """
